...
#figure(
  image("images/ch-4/01-modello_standard.svg", width: 60%),
)
...
#figure(
  image("images/ch-4/02-cooldown_particelle.pdf", width: 46%),
)
...
#let figura_cono_sup = [#figure(
  image("images/ch-4/03-cono_superficie.pdf", width: 90%),
)]
...
#figure(
  image("images/ch-4/04-densita_primordiale.pdf", width: 50%),
)
...
#figure(
  include "images/ch-4/feynmann_debole.typ",
)
...
#figure(
  include "images/ch-4/feynmann_fermi.typ",
)
...
#figure(
  image("images/ch-4/05-gradi_lib.png", width: 80%),
...
#figure(
  image("images/ch-4/06-evoluzione_temperatura.jpg", width: 50%),
...
#subpar.grid(
  figure(
    image("images/ch-4/07-2-nucleosintesis2.png", width: 85%),
  ),
  figure(
    image("images/ch-4/07-1-nucleosintesis.jpg", width: 80%),
  ),
...
$
#figure(
  image("images/ch-4/08-conc_elett.pdf", width: 60%),
...
#figure(
  image("images/ch-4/09-conc_elett2.pdf", width: 60%),
  caption: [Evoluzione della frazione di elettroni liberi durante la ricombinazione\
...
#figure(
  image("images/ch-4/10-vis_deriv.pdf", width: 50%),
)
...
#figure(
  image("images/ch-4/11-1-visibility.png", width: 60%),
)
